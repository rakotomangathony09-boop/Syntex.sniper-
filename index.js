...
const token = '8694426433:AAF9Wmt7VQ34AalQsQqbknPKtWtmbtvPMrQ';
...
// 3. INTERFACE WEB (Pour Render et UptimeRobot)
// Cette partie crée la page web que vous verrez en visitant votre lien
const server = http.createServer((req, res) => {
  ...
  res.write(`
    ...
    <head>
      ...
      <style>
        body { background: #0a0a0a; color: #00ff66; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; overflow: hidden; }
    ...
    <body>
      <div class="box">
        <h1>SYNTX SNIPER</h1>
        <div><span class="status-dot"></span><span class="label">SYSTÈME LIVE</span></div>
        <p>TERMINAL ID: <span style="color:#00ff66">#SNIPER-VVIP-01</span></p>
        <p>MONITORING: <span style="color:#fff">GAINX & PAINX FLUX</span></p>
        <p>LOCATION: <span style="color:#fff">OREGON SERVER</span></p>
        <div style="margin-top:20px; font-size: 0.7rem; color: #444;">&copy; 2026 RAKOTOARISOA - ALL RIGHTS RESERVED</div>
      </div>
    </body>
    </html>
  `);
...
// Utilisation dynamique du port imposé par Render
