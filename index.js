...
// 1. CONFIGURATION AVEC VOTRE DERNIER TOKEN VALIDE
const token = '8694426433:AAHijK_HaXmfuloGN7V1vVal6lxUcBWdt00';
const bot = new TelegramBot(token, {polling: true});

console.log("Terminal Sniper de MC Anthonio - Lancement du scan...");

// 2. GESTION DES ERREURS POUR ÉVITER LES CRASHES
bot.on('polling_error', (error) => {
  console.log("Attente de synchronisation Telegram..."); 
});
...
// 4. INTERFACE VISUELLE PRO (Port 10000)
  ...
  res.write(`
    ...
    <head>
      ...
      <style>
        ...
        .box { border: 1px solid #00ff66; padding: 40px; border-radius: 5px; box-shadow: 0 0 30px rgba(0, 255, 102, 0.2); text-align: center; }
        h1 { font-size: 1.8rem; letter-spacing: 4px; margin-bottom: 5px; color: #fff; }
    ...
    <body>
      <div class="box">
        ...
        <div style="margin-top:20px; font-size: 0.7rem; color: #444;">&copy; 2026 M.A. RAKOTOMANGA - VVIP ACCESS</div>
      </div>
    </body>
    </html>
  `);
...
server.listen(PORT, () => {
  console.log("Serveur de MC Anthonio prêt sur le port " + PORT);
});
